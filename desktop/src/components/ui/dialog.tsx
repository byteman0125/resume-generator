...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    showClose?: boolean;
    /** When true, skip zoom scale animation to avoid blurry text (e.g. in Electron). */
    noZoomAnimation?: boolean;
  }
>(({ className, children, showClose = true, noZoomAnimation = false, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        !noZoomAnimation && "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        className
      )}
      {...props}
    >
