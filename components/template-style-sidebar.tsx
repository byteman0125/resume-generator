...
/** Format number for display: show 0 and other numbers; empty when undefined. */
  ...
  return (
    <aside className="w-72 flex-shrink-0 border-l border-border bg-background flex flex-col overflow-hidden text-xs">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        ...
        {/* Spacing — detailed labels and always show current value */}
        <section>
          {sectionBtn("spacing", "Spacing (inches)")}
          {!collapsed.spacing && (
            <div className="space-y-1.5 pt-0.5">
              <p className="text-[10px] text-muted-foreground px-0.5">
                Page edge spacing uses PDF margin (fixed). Section gap = space above/below each block. Bullet = list indent &amp; item gap.
              </p>
              <div>
                <Label className="text-[10px] text-muted-foreground">Section top (in) — space above each section</Label>
                <Input
                  type="number"
                  min={0}
                  step={0.05}
              ...
              <div>
                <Label className="text-[10px] text-muted-foreground">Section bottom (in) — space below each section</Label>
                <Input
                  type="number"
                  min={0}
                  step={0.05}
              ...
              <div>
                <Label className="text-[10px] text-muted-foreground">Bullet indent (in) — left indent of list</Label>
                <Input
                  type="number"
                  min={0}
                  step={0.05}
              ...
              <div>
                <Label className="text-[10px] text-muted-foreground">Bullet gap (in) — space between list items</Label>
                <Input
                  type="number"
                  min={0}
                  step={0.01}
            ...
            <div className="space-y-1.5 pt-0.5">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  checked={style.showHeaderDivider !== false}
                  onChange={(e) => update({ showHeaderDivider: e.target.checked })}
                  className="h-3.5 w-3.5"
                />
                <Label htmlFor="showHeaderDivider" className="text-[10px]">Header divider</Label>
              </div>
              <div>
